...
* If given examples with the problem, make sure you fully work through each one and understand *why* it works
...
* Solve problem with at least three different inputs to make sure you actually understand the solution for more than one case
    - i.e., Solve for 1, then for 2, and then for *n*
...
* Try to simplify the solution *before* you code, if possible
...
* NOTE: For *any* programming language you expect to be able to work/solve **algorithm type problems** in, you'll need to know how to do the following:
    - Create a list
...
* If you don't know how to do *all* of these things - **stop now and learn them!**
...
* **"Divide and Conquer"** is an effective method for break down problems
